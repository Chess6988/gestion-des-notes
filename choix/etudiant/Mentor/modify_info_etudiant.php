...
<body>
    <div class="container mt-5">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Modifier un compte (Étudiant)</h5>
                <form id="modifyForm">
                    <div class="form-group">
                        <label for="firstName_etudiant">First Name (Nom)</label>
                        <input type="text" class="form-control" id="firstName_etudiant" name="firstName_etudiant" value="<?php echo htmlspecialchars($user['firstName_etudiant']); ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="lastName_etudiant">Last Name (Prénom)</label>_etudiant
                        <input type="text" class="form-control" id="lastName_etudiant" name="lastName_etudiant" value="<?php echo htmlspecialchars($user['lastName_etudiant']); ?>" required>
                    </div>
                    <div class="form-group">
                ...
                <p class="mt-3" style="color:red;">Cliquez ici <a href="signin_etudiant.html">Login</a> si votre compte est OK</p>
            </div>
        </div>
    </div>
